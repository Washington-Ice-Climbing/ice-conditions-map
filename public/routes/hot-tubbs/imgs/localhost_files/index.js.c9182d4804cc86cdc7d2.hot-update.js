...
/* harmony import */ var antd_lib_divider_style__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! antd/lib/divider/style */ "./node_modules/antd/lib/divider/style/index.js");
...
/* harmony import */ var _components_Topbar__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../components/Topbar */ "./components/Topbar.js");
...
var _jsxFileName = "/Users/kyle.mccrohan/ice/ice-conditions-map/pages/index.js";
...
function Index() {
  ...
  }, __jsx(_components_Topbar__WEBPACK_IMPORTED_MODULE_15__["default"], {
    title: "WA Ice",
  ...
  }), __jsx(antd_lib_layout__WEBPACK_IMPORTED_MODULE_13___default.a, {
    style: {
      paddingTop: '64px',
      minHeight: '100vh'
    },
  ...
  }, "Beta, community, and inspiration for ice climbing in the Evergreen State. Sharpen your tools. The hunt is on."), __jsx("div", {
    style: {
      margin: "40px"
    },
    __self: this,
  ...
  }, "Browse Routes")), __jsx(antd_lib_button__WEBPACK_IMPORTED_MODULE_9___default.a, {
    size: "large",
    style: {
      width: "200px",
      margin: "10px"
  ...
  }, "The state of Washington is known for many things - winding waterways, rugged mountains, beautiful forests - but one thing it is not known for is ice climbing. Our wet, maritime climate makes it challenging to find reliable ice climbing conditions. Poor access confines winter recreation to a few distinct areas. A lack of information and up-to-date condition reports makes ice climbing more of a gamble than many feel is worthy for the reward."), __jsx("p", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44,
  ...
  }, "Although Washington lacks in reliable low elevation water ice, it does have it fair share of rugged alpine ice climbs. This guide aims to demystify many of these climbs - which are not as remote or impossible as they may seem. Additionally, it seeks to catalog the rich history of alpine climbing in Washington, which continues to evolve. Browse, research, dream, and send!")), __jsx(antd_lib_divider__WEBPACK_IMPORTED_MODULE_7___default.a, {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 51,
  ...
  }, "Technology is changing. So is climbing. Guidebooks should too."), __jsx(antd_lib_row__WEBPACK_IMPORTED_MODULE_1___default.a, {
    gutter: 16,
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.c9182d4804cc86cdc7d2.hot-update.js.map